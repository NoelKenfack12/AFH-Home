...
class Categorie extends \Produit\ProduitBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'id', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'nom', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'rang', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'date', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'user', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'souscategories', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'src', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'alt', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'file', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'tempFilename', '' . "\0" . 'Produit\\ProduitBundle\\Entity\\Categorie' . "\0" . 'servicetext');
        }
