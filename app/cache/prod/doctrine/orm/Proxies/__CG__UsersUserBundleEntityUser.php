...
class User extends \Users\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'facebook', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'twitter', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'linkedin', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'google', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'categorie', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'specialite', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'apropos', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'mailval', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'datebeg', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'dateend', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'teamyear', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'dateins', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'telval', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'pays', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'imgprofil', '' . "\0" . 'Users\\UserBundle\\Entity\\User' . "\0" . 'servicetext');
        }
    ...
    public function setApropos($apropos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setApropos', array($apropos));
    ...
    public function getApropos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getApropos', array());
    ...
    public function setTeamyear($teamyear)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTeamyear', array($teamyear));

        return parent::setTeamyear($teamyear);
    }
    ...
    public function getTeamyear()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTeamyear', array());

        return parent::getTeamyear();
    }
