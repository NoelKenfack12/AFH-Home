...
use App\Repository\Produit\Service\TypearticleRepository;
...
class Typearticle
{
    ...
    */
	...
	/**
   * @ORM\OneToMany(targetEntity=Service::class, mappedBy="typearticle")
   */
    private $services;
	...
	*/
	...
	public function getServicesFilter()
	{
		$liste_service = $this->em->getRepository(Service::class)
	                         ->findBy(array('type'=>$this),array('rang'=>'asc'));
	...
	public function getProduitFilter()
	{
		$liste_produit = $this->em->getRepository(Produit::class)
	                         ->findBy(array('typearticle'=>$this),array('rang'=>'asc'));
    ...
    public function removeService(Service $services): self
    {
