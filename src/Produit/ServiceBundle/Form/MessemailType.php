...
class MessemailType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('link','text',array('attr'=>array('placeholder'=>'Lien de redirection','style'=>'width: 100%;')))
            ->add('contenu','textarea',array('attr'=>array('placeholder'=>'Contenu','style'=>'width: 100%; height: 150px; border: 1px solid #9e9e9e;')))
        ;
    }
